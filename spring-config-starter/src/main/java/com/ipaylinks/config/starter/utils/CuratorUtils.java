package com.ipaylinks.config.starter.utils;

import com.google.gson.Gson;
import com.ipaylinks.config.starter.model.Prop;
...
public class CuratorUtils {
    private static final Logger log = LogManager.getLogger(CuratorUtils.class);
